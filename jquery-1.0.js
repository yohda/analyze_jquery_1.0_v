...
// jQuery에 메소드를 추가할 때, jQuery.fn으로 접근해서 추가할 수가 있다.
// 그리고 jQuery의 함수객체의 prototype을 변경하고 있다.
// 이렇게 될 경우 jQuery생성자를 통해서 만들어진 객체는 Function.prototype에 있는 기능들을 쓸 수가 없다.
...
// extend메소드를 정의하는 부분
// static 메소드와 객체 메소드에서 모두 사용가능하게 하였다.
...
// extend메소드가 호출되는 코드이다.
// jQuery객체에 객체 리터럴 방식으로 많은 메소드(기능)를 추가하고 있다.
jQuery.extend({
	init: function(){
